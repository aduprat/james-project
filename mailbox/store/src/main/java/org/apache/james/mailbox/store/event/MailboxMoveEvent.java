...
public class MailboxMoveEvent implements Event {
    ...
    public static class Builder {
        ...
        public MailboxMoveEvent build() {
            ...
            return new MailboxMoveEvent(session, messageMoves, messages);
        }
    }
    ...
    @VisibleForTesting MailboxMoveEvent(MailboxSession session, MessageMoves messageMoves, Map<MessageUid, MailboxMessage> messages) {
        this.session = session;
        this.messageMoves = messageMoves;
