...
public class MailboxEventDispatcher {
     ...
     * MailboxListener will get triggered then
     */
    public void mailboxDeleted(MailboxSession session, Mailbox mailbox, QuotaRoot quotaRoot, QuotaCount quotaCount, QuotaSize quotaSize) {
        listener.event(eventFactory.mailboxDeleted(session, mailbox, quotaRoot, quotaCount, quotaSize));
    }
