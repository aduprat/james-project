...
public class CassandraMessageRowHandler {
    ...
    public static class Builder {
        ...
        private Row row;
        private UniqueMessageId messageId;
        ...
        public Builder messageId(UniqueMessageId messageId) {
    ...
    private final UniqueMessageId messageId;
    private final Function<List<AttachmentId>, List<Attachment>> attachmentsFunction;

    public CassandraMessageRowHandler(Row row, UniqueMessageId messageId, Function<List<AttachmentId>, List<Attachment>> attachmentsFunction) {
        this.row = row;
        this.messageId = messageId;
        this.attachmentsFunction = attachmentsFunction;
    }
