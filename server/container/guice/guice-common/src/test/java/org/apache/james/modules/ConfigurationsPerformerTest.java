...
public class ConfigurationsPerformerTest {
    ...
    private static class MyModule extends CommonServicesModule<InMemoryId> {

        public MyModule() {
            super(new TypeLiteral<InMemoryId>(){});
        }
    ...
    public static class AConfigurationPerformer implements ConfigurationPerformer {
    ...
    public static class BConfigurationPerformer implements ConfigurationPerformer {
