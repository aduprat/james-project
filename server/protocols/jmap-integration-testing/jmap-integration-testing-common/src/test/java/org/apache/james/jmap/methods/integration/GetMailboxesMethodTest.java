...
public abstract class GetMailboxesMethodTest {
    ...
    public void setup() throws Throwable {
        ...
        DataProbe dataProbe = jmapServer.getProbe(PojoDataProbe.class);
    ...
    public void getMailboxesShouldReturnMailboxesWhenIdsMatch() throws Exception {
        mailboxProbe.createMailbox(MailboxConstants.USER_NAMESPACE, username, "INBOX");
        mailboxProbe.createMailbox(MailboxConstants.USER_NAMESPACE, username, "myMailbox");

        Mailbox mailbox = mailboxProbe.getMailbox(MailboxConstants.USER_NAMESPACE, username, "INBOX");
