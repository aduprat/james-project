...
public interface SpamAssassinContract {
    ...
    String ANGELS_DOMAIN = "angels.org";
    String ALICE = "alice@" + ANGELS_DOMAIN;
    String ALICE_PASSWORD = "alicePassword";
    String PAUL = "paul@" + ANGELS_DOMAIN;
    ...
    default void setup(JamesWithSpamAssassin james) throws Throwable {
        ...
        james.getJmapServer().getProbe(DataProbeImpl.class).addDomain(ANGELS_DOMAIN);
