...
public abstract class GetMessageListMethodTest {
    ...
    public void getMessageListShouldReturnAllMessagesWhenMultipleMailboxesAndNoParameters() throws Exception {
        ...
        MailboxPath mailboxPath2 = new MailboxPath(MailboxConstants.USER_NAMESPACE, user, "mailbox");
        jmapServer.createMailbox(user, mailboxPath2);
        jmapServer.appendMessage(user, mailboxPath2, new ByteArrayInputStream("Subject: test\r\n\r\ntestmail".getBytes()), new Date(), false, new Flags());
