...
public class MailboxTest {
    ...
    public void fromShouldWork() {
        ...
        dto.parentId = expectedParentId;
        dto.role = expectedRole.name();
        dto.sortOrder = expectedSortOrder;
        dto.mustBeOnlyMailbox = expectedMustBeOnlyMailbox;
        dto.mayReadItems = expectedMayReadItems;
        dto.mayAddItems = expectedMayAddItems;
        dto.mayRemoveItems = expectedMayRemoveItems;
        dto.mayCreateChild = expectedMayCreateChild;
        dto.mayRename = expectedMayRename;
        dto.mayDelete = expectedMayDelete;
        dto.totalMessages = expectedTotalMessages;
        dto.unreadMessages = expectedUnreadMessages;
        dto.totalThreads = expectedTotalThreads;
        dto.unreadThreads = expectedUnreadThreads;

        Mailbox mailbox = Mailbox.from(dto);
