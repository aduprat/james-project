...
public class GetMailboxesMethodTest {
    ...
    public void setup() throws Exception {
        ...
        getMailboxesMethod = new GetMailboxesMethod<>(mailboxManager, mailboxMapperFactory, mailboxUtils);
    }
    ...
    public void getMailboxesShouldNotFailWhenMailboxManagerErrors() throws Exception {
        ...
        GetMailboxesMethod<InMemoryId> testee = new GetMailboxesMethod<>(mockedMailboxManager, mailboxMapperFactory, mailboxUtils);
