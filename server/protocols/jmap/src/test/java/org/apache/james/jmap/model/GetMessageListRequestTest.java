...
public class GetMessageListRequestTest {
    ...
    public void builderShouldWork() {
        ...
        GetMessageListRequest expectedGetMessageListRequest = new GetMessageListRequest(Optional.empty(), Optional.of(filterCondition), sort, false, 1, Optional.empty(), Optional.empty(), Optional.of(2),
                false, false, fetchMessageProperties, false);
