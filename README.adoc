...
First step, you have to build the Docker image
    ...
    $ docker build -t build-james-deb --build-arg ITERATION=1 dockerfiles/packaging/debian/

Where:

- ITERATION is increment of the release of the package (e.g. 3.0-beta6-1, 3.0-beta6-2, 3.0-beta6-3...)
...
- $PWD/jars is the path to the folder containing the James jars/libs
